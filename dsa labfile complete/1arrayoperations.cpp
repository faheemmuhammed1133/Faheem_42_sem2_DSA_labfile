...
void showArray(int &a, int arr[]) // function to display array and number of elements in array
{
    int count = 0;
    cout << "Array: ";
    for (int i = 0; i < a; i++)
...
void insertAtIndex(int &c, int arr[]) // function to insert element at specified index location in the array
{
    int a, b;
